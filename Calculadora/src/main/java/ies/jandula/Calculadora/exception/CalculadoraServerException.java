package ies.jandula.Calculadora.exception;
 ...
 */
public class CalculadoraServerException extends Exception
{
	/**
	 * Serial Version UID
	 */
	 ...
	 */
	public CalculadoraServerException(int code, String message) 
	{
		super(message);
	 ...
	 */
	public CalculadoraServerException(int code, String message, Exception exception) 
	{
