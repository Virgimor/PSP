...
public class VideoclubException extends Exception {
	 ...
	 */
	public VideoclubException(int code, String message) 
	{
		super(message);
	 ...
	 */
	public VideoclubException(int code, String message, Exception exception) 
	{
	...
	// Método para obtener el código de error , esto lo he cambiado yo manualmente
    public int getCode() {
        return this.code;
    }
	/**
